    ...
    <section id="services" class="py-16">
      <div class="container mx-auto">
        ...
        <div class="serviceBox flex flex-wrap flex-row items-stretch text-center justify-center pt-6">
          ...
          <div class="service relative lg:max-w-xs p-1 lg:p-3">
            <g-image class="rounded" src="~/assets/img/add.jpg"/>
            <h3 class="serviceName bg-blue rounded px-1 py-3 text-white w-4/5 overflow-hidden mx-auto">Adult ADD/ADHD</h3>
          </div>
          <div class="service relative lg:max-w-xs p-1 lg:p-3">
            <g-image class="rounded" src="~/assets/img/tms.jpg"/>
            <h3 class="serviceName bg-blue rounded px-1 py-3 text-white w-4/5 overflow-hidden mx-auto">TMS Therapy</h3>
          </div>
          <div class="service relative lg:max-w-xs p-1 lg:p-3">
            <g-image class="rounded" src="~/assets/img/ket.jpg"/>
            <h3 class="serviceName bg-blue rounded px-1 py-3 text-white w-4/5 overflow-hidden mx-auto">Ketamine for depression</h3>
          </div>
          <div class="service relative lg:max-w-xs p-1 lg:p-3">
            <g-image class="rounded" src="~/assets/img/sub.jpg"/>
            <h3 class="serviceName bg-blue rounded px-1 py-3 text-white w-4/5 overflow-hidden mx-auto">Buprenorphine Suboxone</h3>
          </div>
         </div>
      </div>
    </section>
